...
GOOGLE_API_KEY = google_api_key #Here the api key should be filled
genai.configure(api_key=GOOGLE_API_KEY)
model = genai.GenerativeModel('gemini-1.5-flash-002')

# Agent A's current energy and energy needed for the upcoming process
agent_A_current_energy = 30  # kW
agent_A_energy_needed = 20  # kW (Energy needed for the upcoming process)
...
if __name__ == "__main__":
    requested_energy = 10  # kW (Energy requested by Agent A)
